...
enum AAX_EStemFormat
{
	...
	AAX_eStemFormatNum			= 13,							// This needs to increase as stem types are added.
...
{
	AAX_eDataInPortType_Unbuffered		= 0,	///< Data port is unbuffered.
	AAX_eDataInPortType_Buffered				///< Data port is buffered both on the host and DSP.
