...
public:	
	...
	/**	\brief Alert the host to a mouse down event
		...
		\param[in] iNumOfParams
			Number of parameter IDS
		\param[in] iModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleMultipleParametersMouseDown ( const AAX_CParamID* iParamIDs, uint32_t iNumOfParams, uint32_t iModifiers ) = 0;
	/**	\brief Alert the host to a mouse drag event
		...
		\param[in] iModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleMultipleParametersMouseDrag ( const AAX_CParamID* iParamIDs, uint32_t iNumOfParams, uint32_t iModifiers ) = 0;
	/**	\brief Alert the host to a mouse up event
		...
		\param[in] iModifiers
			A bitmask of \ref AAX_EModifiers values
	 */
	virtual AAX_Result	HandleMultipleParametersMouseUp   ( const AAX_CParamID* iParamIDs, uint32_t iNumOfParams, uint32_t iModifiers ) = 0;
