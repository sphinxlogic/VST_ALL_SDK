...
public:
	...
	enum EMode
	{
		...
		/// @cond INTERNAL_DOCS
		eMode_Version = 1,		///< Not used by %AAX plug-ins
		eMode_SpiSlave = 2,		///< Not used by %AAX plug-ins
		eMode_GP = 3,			///< Not used by %AAX plug-ins
		eMode_FifoWrite = 4,	///< Not used by %AAX plug-ins
		eMode_FifoRead = 5,		///< Not used by %AAX plug-ins
		/*eMode_Burst = 6,*/
		eMode_Interrupt = 7,	///< Not used by %AAX plug-ins
		eMode_SkipRead = 8,		///< Not used by %AAX plug-ins
		eMode_SkipWrite = 9		///< Not used by %AAX plug-ins
		/*eMode_Gather = 10,*/
		/*eMode_Scatter = 11*/
		/// @endcond
	}; 
