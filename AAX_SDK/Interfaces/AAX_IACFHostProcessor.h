...
public:
	...
	virtual AAX_Result		RenderAudio ( const float * const iAudioIns [], int32_t iAudioInCount, float * const iAudioOuts [], int32_t iAudioOutCount, int32_t * ioWindowSize ) = 0;	///< \copydoc AAX_CHostProcessor::RenderAudio()
	virtual AAX_Result		PreRender ( int32_t iAudioInCount, int32_t iAudioOutCount, int32_t iWindowSize ) = 0;	///< \copydoc AAX_CHostProcessor::PreRender()
	virtual AAX_Result		PostRender () = 0;	///< \copydoc AAX_CHostProcessor::PostRender()

	virtual AAX_Result		AnalyzeAudio ( const float * const iAudioIns [], int32_t iAudioInCount, int32_t * ioWindowSize ) = 0;	///< \copydoc AAX_CHostProcessor::AnalyzeAudio()
	virtual AAX_Result		PreAnalyze ( int32_t iAudioInCount, int32_t iWindowSize ) = 0;	///< \copydoc AAX_CHostProcessor::PreAnalyze()
