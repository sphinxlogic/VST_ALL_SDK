...
/** @brief	An 8-byte aligned double to be used in data structures passed between host and DSP,
			like context blocks.
 
	\todo UNUSED - FLAGGED FOR REMOVAL
 */
...
/*! \brief Determines whether a particular AAX_CSampleRate is present
	in a given mask of AAX_ESampleRateMask.
