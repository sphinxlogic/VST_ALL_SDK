...
public:
     ...
     *
	 */
    virtual AAX_Result		GetClipNameSuffix ( int32_t inMaxLength, AAX_IString* outString ) const;
...
protected:
	 ...
	 *
	 *	\param[in] iAudioIns
	 *		Timeline audio buffer(s). This must be set to \c iAudioIns from \ref AAX_IHostProcessor::RenderAudio()
	 *		\internal See PTSW-183848: AAX_IHostProcessor::GetAudio() ignores input audio buffer parameter \endinternal
	 *	\param[in] iAudioInCount
	 *		Number of buffers in \c iAudioIns. This must be set to \c iAudioInCount from \ref AAX_IHostProcessor::RenderAudio()
	 *		\internal See PTSW-183848: AAX_IHostProcessor::GetAudio() ignores input audio buffer parameter \endinternal
	 *	\param[in] iLocation
