...
// *******************************************************************************
const juce::Colour AAX_JuceContentView::getBackgroundColour() const throw()
{
...
{
	if ( mBackgroundImage )
		inGraphics.drawImage ( *mBackgroundImage, 0, 0, this->getWidth(), this->getHeight(), 0, 0, mBackgroundImage->getWidth (), mBackgroundImage->getHeight () );	
	else inGraphics.fillAll(this->getBackgroundColour());
}
