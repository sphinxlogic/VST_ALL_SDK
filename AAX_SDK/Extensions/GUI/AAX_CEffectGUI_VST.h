...
public:
	...
	virtual bool setPosition (VSTGUI::CCoord x, VSTGUI::CCoord y);

	virtual bool setSize (VSTGUI::CCoord width, VSTGUI::CCoord height);
	virtual bool getSize (VSTGUI::CRect *pSize) const;
	virtual bool getSize (VSTGUI::CRect &pSize) const;
...
protected:
	...
	virtual void onDragEnter (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where);
	virtual void onDragLeave (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where);
	virtual void onDragMove (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where);
