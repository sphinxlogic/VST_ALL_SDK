...
VSTGUI_ContentView::VSTGUI_ContentView(void *pSystemWindow, AAX_IEffectParameters* pParams, VSTGUI::VSTGUIEditorInterface *pEditor)
	: VSTGUI::CFrame(VSTGUI::CRect (0,0,0,0), pSystemWindow, pEditor)
...
// *******************************************************************************
bool VSTGUI_ContentView::onDrop (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where)
{
...
// *******************************************************************************
void VSTGUI_ContentView::onDragEnter (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where)
{
	VSTGUI::CRect viewSize(0, 0, 0, 0);
	this->getSize(viewSize);
...
// *******************************************************************************
void VSTGUI_ContentView::onDragMove (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where)
{
	VSTGUI::CRect viewSize(0, 0, 0, 0);
	this->getSize(viewSize);
...
// *******************************************************************************
void VSTGUI_ContentView::onDragLeave (VSTGUI::IDataPackage* drag, const VSTGUI::CPoint& where)
{
	VSTGUI::CRect viewSize(0, 0, 0, 0);
	this->getSize(viewSize);
...
AAX_Result AAX_CEffectGUI_VST::GetViewSize ( AAX_Point *oEffectViewSize ) const
{
	if (mViewComponent)
	{
		...
		oEffectViewSize->horz = (float) viewSize.width();
		oEffectViewSize->vert = (float) viewSize.height();
	}
