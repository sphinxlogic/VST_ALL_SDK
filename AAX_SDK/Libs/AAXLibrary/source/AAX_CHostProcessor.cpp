...
// METHOD:	RenderAudio
// ***************************************************************************
AAX_Result AAX_CHostProcessor::RenderAudio ( const float * const /*iAudioIns*/ [], int32_t /*iAudioInCount*/, float * const /*iAudioOuts*/ [], int32_t /*iAudioOutCount*/, int32_t * /*ioWindowSize*/ )
{
...
// METHOD:	PreRender
// ***************************************************************************
AAX_Result AAX_CHostProcessor::PreRender ( int32_t /*iAudioInCount*/, int32_t /*iAudioOutCount*/, int32_t /*iWindowSize*/ )
{
	return AAX_SUCCESS;
}
...
// METHOD:	AnalyzeAudio
// ***************************************************************************
AAX_Result AAX_CHostProcessor::AnalyzeAudio ( const float * const /*iAudioIns*/ [], int32_t /*iAudioInCount*/, int32_t * /*ioWindowSize*/ )
{
	return AAX_ERROR_UNIMPLEMENTED;
}
...
// METHOD:	PreAnalyze
// ***************************************************************************
AAX_Result AAX_CHostProcessor::PreAnalyze ( int32_t /*iAudioInCount*/, int32_t /*iWindowSize*/ )
{
	return AAX_SUCCESS;
}
...
// METHOD:	GetAudio
// ***************************************************************************
AAX_Result AAX_CHostProcessor::GetAudio ( const float * const inAudioIns [], int32_t inAudioInCount, int64_t iLocation, int32_t * ioNumSamples )
{
	return mHostProcessingDelegate->GetAudio( inAudioIns, inAudioInCount, iLocation, ioNumSamples );
}
