...
DemoGain_SliderVST::DemoGain_SliderVST (const VSTGUI::CRect& size, CControlListener* listener, long tag, long iMinPos, long iMaxPos, VSTGUI::CBitmap* handle, VSTGUI::CBitmap* background, const VSTGUI::CPoint& offset, const long style)
...
DemoGain_SliderVST::DemoGain_SliderVST (const VSTGUI::CRect& rect, CControlListener* listener, long tag, const VSTGUI::CPoint& offsetHandle, long rangeHandle, VSTGUI::CBitmap* handle, VSTGUI::CBitmap* background, const VSTGUI::CPoint& offset, const long style)
