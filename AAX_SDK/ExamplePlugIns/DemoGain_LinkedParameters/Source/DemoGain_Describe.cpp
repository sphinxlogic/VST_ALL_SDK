...
AAX_CEffectID kEffectID_DemoGain	= "com.avid.aax.sdk.demogain.link";
...
static void DescribeAlgorithmComponent( AAX_IComponentDescriptor * outDesc )
{
	...
	properties->AddProperty ( AAX_eProperty_TI_InstanceCycleCount, 130 );
...
static AAX_Result DemoGain_GetPlugInDescription( AAX_IEffectDescriptor * outDescriptor )
{
	...
	// Effect identifiers
	//
	outDescriptor->AddName ( "Demo Gain (Linked Parameters)" );
	outDescriptor->AddName ( "Demo Gain (Link)" );
	outDescriptor->AddName ( "DemoGain Link" );
	outDescriptor->AddName ( "DG Link" );
	outDescriptor->AddName ( "DGLk" );
	outDescriptor->AddName ( "Dl" );
	...
	outDescriptor->AddMeterDescription( cDemoGain_MeterID[eMeterTap_PreGain_L], "Input L", meterProperties );
	outDescriptor->AddMeterDescription( cDemoGain_MeterID[eMeterTap_PreGain_R], "Input R", meterProperties );
    //
	...
	meterProperties->AddProperty ( AAX_eProperty_Meter_Orientation, AAX_eMeterOrientation_Default );
	outDescriptor->AddMeterDescription( cDemoGain_MeterID[eMeterTap_PostGain_L], "Output L", meterProperties );
	outDescriptor->AddMeterDescription( cDemoGain_MeterID[eMeterTap_PostGain_R], "Output R", meterProperties );
