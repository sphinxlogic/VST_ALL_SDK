...
AAX_CEffectID kEffectID_DemoDelay	= "com.avid.aax.sdk.demodelay.hybrid";
...
static void DescribeAlgorithmComponent( AAX_IComponentDescriptor * outDesc )
{
	...
	properties->AddProperty ( AAX_eProperty_HybridInputStemFormat, AAX_eStemFormat_Mono );
	properties->AddProperty ( AAX_eProperty_HybridOutputStemFormat, AAX_eStemFormat_Mono );
	...
	properties->AddProperty ( AAX_eProperty_TI_InstanceCycleCount, 170 );
...
static AAX_Result DemoDelay_GetPlugInDescription( AAX_IEffectDescriptor * outDescriptor )
{
	...
	// Effect identifiers
	//
	outDescriptor->AddName ( "Demo Delay (Hybrid)" );
	outDescriptor->AddName ( "Demo Delay (Hyb)" );
	outDescriptor->AddName ( "Demo Dly Hyb" );
	outDescriptor->AddName ( "DmDly Hy" );
...
AAX_Result GetEffectDescriptions( AAX_ICollection * outCollection )
{
	...
	outCollection->AddPackageName( "DemoDelay Hybrid" );
