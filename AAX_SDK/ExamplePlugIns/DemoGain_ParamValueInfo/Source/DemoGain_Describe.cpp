...
AAX_CEffectID kEffectID_DemoGain	= "com.avid.aax.sdk.demogain.paramvalueinfo";
AAX_CEffectID kEffectName_DemoGain[] = { "Demo Gain Param Value Info", "DmGnPVI", "DGvi", "Di", 0 };
...
static AAX_Result DemoGain_GetPlugInDescription( AAX_IEffectDescriptor * outDescriptor )
{
	...
	{
		outDescriptor->AddName ( kEffectName_DemoGain[index] );
	}
