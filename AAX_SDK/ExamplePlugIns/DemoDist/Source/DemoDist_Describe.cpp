...
AAX_CEffectID kEffectID_DemoDist = "com.avid.aax.sdk.demodist";
...
void DescribeAlgComponent ( AAX_EStemFormat inStemFormat, AAX_IComponentDescriptor &	outDesc)
{
	...
	switch( inStemFormat )
	{
		case AAX_eStemFormat_Mono:
		{
			...
			properties->AddProperty ( AAX_eProperty_TI_InstanceCycleCount, 692 );
			properties->AddProperty ( AAX_eProperty_TI_SharedCycleCount, 156 );
#endif // _DEBUG
		...
		case AAX_eStemFormat_Stereo:
		{
			...
			// Resource requirements
#ifndef AAX_TI_BINARY_IN_DEVELOPMENT // Define this macro when using a debug TI DLL to allocate only 1 instance per chip
			properties->AddProperty ( AAX_eProperty_TI_InstanceCycleCount, 1121 );
			properties->AddProperty ( AAX_eProperty_TI_SharedCycleCount, 236 );
#endif // _DEBUG
...
AAX_Result DemoDist_GetPlugInDescription(AAX_IEffectDescriptor&	outDescriptor)
{
	...
	outDescriptor.AddName ( "DemoDist" );
...
AAX_Result GetEffectDescriptions ( AAX_ICollection * outCollection )
{
	...
	outCollection->AddPackageName( "DemoDist AAX Plug-In" );
