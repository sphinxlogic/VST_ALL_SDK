...
AAX_CEffectID kEffectID_DemoDelay	= "com.avid.aax.sdk.demodelay.dyncomp";
...
static AAX_Result DemoDelay_GetPlugInDescription( AAX_IEffectDescriptor * outDescriptor )
{
	...
	// Effect identifiers
	//
	outDescriptor->AddName ( "Demo Delay (Dynamic Latency Compensation)" );
	outDescriptor->AddName ( "Demo Delay (Dyn Latency Comp)" );
	outDescriptor->AddName ( "Demo Delay (Dyn Comp)" );
	outDescriptor->AddName ( "Demo Delay Dyn Comp" );
	outDescriptor->AddName ( "Demo Dly Cmp" );
...
AAX_Result GetEffectDescriptions( AAX_ICollection * outCollection )
{
	...
	outCollection->AddPackageName( "DemoDelay DynComp" );
