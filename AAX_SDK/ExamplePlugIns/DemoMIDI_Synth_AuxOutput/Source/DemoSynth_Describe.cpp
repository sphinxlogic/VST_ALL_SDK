...
AAX_CEffectID kEffectID_DemoSynth	= "com.avid.aax.sdk.demomidi.synth.aos";
...
AAX_Result GetEffectDescriptions( AAX_ICollection * outCollection )
{
	...
	if ( err == AAX_SUCCESS && outCollection )
	{
		// Add the Effect
		err = outCollection->AddEffect( kEffectID_DemoSynth, effectDescriptor );			AAX_ASSERT (err == AAX_SUCCESS);
		
		// Add properties to the Collection
		outCollection->SetManufacturerName( "Avid" );
		outCollection->AddPackageName( "DemoMIDI_Synth_AOS Plug-In" );
		outCollection->AddPackageName( "Demo Synth AOS" );
		outCollection->AddPackageName( "Demo Synth" );
